...
13. 凡因本合約所引起的或與之相關的任何爭議、糾紛、分歧或索賠，包括合同的存在、效力、解釋、履行、違反或終止，或因本合同引起的或與之相關的任何非合同性爭議，均應以下列程序處理：(爭議之金額少於HK 75,000)提交香港仲裁公會並按照其現行有效的香港仲裁公會規則最終解決。
...
20. 如有任何因本公司在安裝或運送過程中令客方物品(如小五金、燈飾等)引致損壞，本公司就該客方物品之最高賠償金額為港幣$500元。本公司並不負責一切保養及維修所有代工安裝 or 代客購買之物料。
